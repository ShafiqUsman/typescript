...
const ratings = [5, 4, 5];
let sum = 0;
const sumFunction = (a, b) => __awaiter(void 0, void 0, void 0, function* () { return a + b; });
ratings.forEach((rating) => __awaiter(void 0, void 0, void 0, function* () {
    sum = yield sumFunction(sum, rating);
}));
...
var FaceStyle;
(function (FaceStyle) {
    FaceStyle[FaceStyle["long"] = 1] = "long";
    FaceStyle[FaceStyle["flat"] = 2] = "flat";
    FaceStyle[FaceStyle["round"] = 3] = "round";
    FaceStyle[FaceStyle["smiley"] = 5] = "smiley";
})(FaceStyle || (FaceStyle = {}));
...
let strArr1 = ['shafiq', 'minhaj'];
let strArr2 = ['mashail', 'maria'];
let anyArr = ['maaz', 10, true];
let myTuple = ['Hi', 10];
console.log(myTuple);
